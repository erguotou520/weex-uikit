<template>
  <div class="v-inputs">
    ...
    <u-input class="input-item" v-model="input2" placeholder="input something" ref="input2">
      <text slot="left" style="fontfamily:'inputfont';font-size:24px;">&#xe639;</text>
      <text v-if="!!input2" slot="right" @click="input2='';$refs.input2.focus()" style="fontfamily:'inputfont';font-size:20px;">&#xe60e;</text>
    </u-input>
  </div>
</template>
<script>
